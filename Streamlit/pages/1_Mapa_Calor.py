# -*- coding: utf-8 -*-
"""
Created on Thu May 25 11:12:01 2023
...
Fecha = list(pozos["FechaMonitoreo"])
...
mapa = folium.Map(location=[7.10, -73.98], zoom_start=5)
# Pozos al mapa
for (
    nomb,
    lat,
    ...
    mc_pozos.add_child(
        folium.Marker(
            ...
            min_width=10000,
            icon=folium.Icon(
                color=col_i, icon_color="blue", icon="tower-observation", prefix=pref
            ),
        )
    )
