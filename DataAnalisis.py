...
for nom, x, y in zip(nombre, X, Y):
     ...
     conexion.execute("insert into Coordenadas(NamePoz,Latitud,Longitud) values(?,?,?)",(nom,(lat - ajusteLatitud), (lon - ajusteLogitud) ))
...
for regi , poz, al, form, are, fecham, bw, bo, bf, bs, Paverage, Pmax, pu25, pu45, pu106, pu250, pu425, cuadri in zip(regist, pozo, als, formacion, area, fechaMonitoreo, bwpd, bopd, bfpd, bsw, PPMaverage, PPMmax, p25to45, p45to106, p106to250, p250to425, pm425, cuadrilla):
    conexion.execute("insert into Info_Monitoreo(REGISTROTYT, NamePoz, ALS, Formacion, AREA, FechaMonitoreo, BWPD, BOPD, BFPD, BSW, PPMaverage, PPMmax, P25to45, P45to106, P106to250, P250to425, PM425, Cuadrilla) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", (regi , poz, al, form, are, str(fecham), bw, bo, bf, bs, Paverage, Pmax, pu25, pu45, pu106,  pu250, pu425, cuadri))
